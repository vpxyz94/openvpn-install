...
function installQuestions() {
	...
	echo "The git repository is available at: https://https://github.com/vpxyz94"
	echo ""
	...
	echo ""
	echo "Czpy is Checking for IPv6 connectivity..."
	echo ""
	...
	echo "Unless you know what you're doing, you should stick with the default parameters provided by my script."
	echo "Note that whatever you choose, all the choices presented in the script are safe. (Unlike OpenVPN's defaults)"
	echo "See https://https://github.com/vpxyz94#security-and-encryption to learn more."
	echo ""
